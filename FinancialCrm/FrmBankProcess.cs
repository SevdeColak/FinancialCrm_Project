...
namespace FinancialCrm
{
    public partial class FrmBankProcess : Form
    {
        ...
        private void FrmBankProcess_Load(object sender, EventArgs e)
        {
            ...
            lblAmount6.Text = bankProcess6.Amount + " ₺";
        }
